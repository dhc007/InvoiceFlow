...
export const CallToActionSection = (): JSX.Element => {
  return (
    <section className="flex flex-col items-start gap-10 px-4 py-10 w-full">
      <div className="flex flex-col items-start gap-4 w-full">
        <div className="flex flex-col items-start max-w-[720px]">
          <h2 className="text-4xl font-black text-[#1c160c] tracking-[-1.00px] leading-[45px] font-sans">
            Benefits
          </h2>
        </div>

        <div className="flex flex-col items-start max-w-[720px]">
          <p className="text-base font-normal text-[#1c160c] leading-6 font-sans">
      ...
      <div className="flex flex-col gap-3 w-full">
        <div className="flex flex-wrap gap-3 w-full">
          {benefits.map((benefit, index) => (
            <Card
              key={index}
              className="w-[301px] bg-[#fcf9f7] border-[#e8e2ce] rounded-lg"
            >
